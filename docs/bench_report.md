...
**時間**：2026-09-16T01:48:10+0800

## 測試結果

| 測試 | 即時倍率 | 耗時 | 每 tick | 記憶體峰值 | 結果 |
|------|---------|------|---------|-----------|------|
| Rust Selftest | N/A | 106.3ms | N/A | N/A | ✅ |
| Rust Tick Speed (76800 ticks) | 4777.6x | 126.0ms | 1.6µs | 0.0MB | ✅ |
| Rust Multi-Client (10 clients, 5.0s) | N/A | 1.97s | N/A | N/A | ✅ |
| Python Tick Speed (3.0s) | 4.9x | 3.00s | 1608.9µs | 1.4MB | ✅ |
