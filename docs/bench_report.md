...
**時間**：2026-09-15T22:48:22+0800

## 測試結果

| 測試 | 即時倍率 | 耗時 | 每 tick | 記憶體峰值 | 結果 |
|------|---------|------|---------|-----------|------|
| Rust Selftest | N/A | 103.1ms | N/A | N/A | ✅ |
| Rust Tick Speed (76800 ticks) | 6326.9x | 95.0ms | 1.2µs | 0.0MB | ✅ |
| Rust Multi-Client (10 clients, 5.0s) | N/A | 1.97s | N/A | N/A | ✅ |
| Python Tick Speed (3.0s) | 3.7x | 3.00s | 2095.4µs | 1.4MB | ✅ |
